...
// claims.json is generated by the GitHub Action sync script;
// no localStorage merging — only real issue data counts.
...
async function init() {
  ...
  // Load claims from the generated claims.json (no localStorage merging)
  claims = await loadStaticClaims();
